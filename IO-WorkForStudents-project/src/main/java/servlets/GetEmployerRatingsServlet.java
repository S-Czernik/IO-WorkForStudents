 ...
 * @author adamk
 */
@WebServlet(name = "GetEmployerRatingsServlet", urlPatterns = {"/GetEmployerRatingsServlet"})
public class GetEmployerRatingsServlet extends HttpServlet {

    Model model;
    
    public GetEmployerRatingsServlet() {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try (PrintWriter out = response.getWriter()) {
			ArrayList<Rating> ratings = model.ratingInterface.getEmployerRating(userID);
